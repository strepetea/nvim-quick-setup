...
-- Make the cursor move via display lines rather than physical lines of the file
...
vim.keymap.set('', '<ScrollWheelDown>', 'j', { noremap = true, silent = true })
...
require('lazy').setup({
  ...
  --  event = 'VimEnter'
  --  loads before all the UI elements are loaded. Events can be
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      require('telescope').setup {
        -- defaults = {
        --   mappings = {
        --     -- i = { ['<c-enter>'] = 'to_fuzzy_refine' }, -- refines the fuzzy search using your current input
        --   },
        -- },
        -- pickers = {}
        extensions = {
